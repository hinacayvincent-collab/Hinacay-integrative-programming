...
function checkLoginStatus() {
  ...
  if (!isLoggedIn && (window.location.pathname.includes('profile.html') || window.location.pathname.includes('settings.html'))) {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  logoutButtons.forEach(btn => {
    if (btn.textContent.includes('Logout') || btn.textContent.includes('LOGOUT')) {
